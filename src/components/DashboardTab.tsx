  ...
  return (
    <div className="space-y-5 p-4 pb-20">
      ...
      {currentUser ? (
        ...
        <div className="bg-[#D6E8C1]/30 p-4 rounded-2xl border border-brand-primary/20 shadow-xs flex items-center justify-between gap-4">
          <div className="space-y-1">
      ...
      <div className="bg-brand-card/70 p-4 rounded-2xl border border-brand-border shadow-sm flex flex-col gap-3">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0 flex-grow">
            ...
            <p className="text-xs text-brand-dark truncate font-mono">
              {csvMessage}
            </p>
          </div>
        </div>
        <div className="flex items-center justify-end gap-2 border-t border-brand-border pt-2.5">
          <button 
      ...
      <div className="bg-brand-hero text-brand-herotext rounded-2xl p-5 shadow-sm border border-brand-border relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-2">
          ...
          <h2 className="text-xl font-black font-display leading-snug text-brand-herotext">
          ...
          <div className="flex flex-wrap gap-2 pt-2">
            <button 
              ...
              className="bg-brand-primary text-white hover:bg-brand-muted font-extrabold text-xs px-4 py-2 rounded-xl shadow-sm transition active:scale-95 flex items-center gap-1.5"
            >
              Catat Setor Sampah
            </button>
            <button 
              onClick={() => onSwitchTab('panduan')}
              className="bg-brand-card/70 hover:bg-brand-card border border-brand-border text-brand-dark font-bold text-xs px-3 py-2 rounded-xl transition flex items-center gap-1"
            >
              Cara Pilah
            </button>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="bg-brand-card/75 p-5 rounded-2xl border border-brand-border shadow-sm space-y-4">
          ...
          <div className="divide-y divide-[#DDE1D2] max-h-[280px] overflow-y-auto pr-1 space-y-1">
